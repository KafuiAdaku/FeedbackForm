#!/usr/bin/python3
"""Module defining view functions for user login"""
from flask import (
    Blueprint,
    redirect,
    request,
...
from feedback_form.blueprints.user.forms import (
    LoginForm,
...
def login():
    ...
    if form.is_submitted() and form.validate():
        ...
        if u and u.authenticated(password=request.form.get("password")):
            ...
            if login_user(u, remember=remember) and u.is_active():
...
def signup():
    ...
    if form.is_submitted() and form.validate():
        ...
        session['signup_user'] = {'id': u.id, 'username': None}
